...
parser.add_argument('--insize', default=11, type=int, help='Input vector bitwidth; max 64')
parser.add_argument('--add_cin', default='n', nargs='?', choices=['n', 'y'], help='Add add_in input (n/y)')
parser.add_argument('--output', default="/project/cadscripts/NeoLogicRoot/VerilogENV/mul_project/mul_12/mul_12_dadda.v", help='Output file name')
